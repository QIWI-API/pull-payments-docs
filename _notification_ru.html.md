...
<aside class="notice">
Чтобы начать получать уведомления, на сайте <a href="https://kassa.qiwi.com">QIWI Касса</a> достаточно указать адрес сервера для обработки уведомлений (раздел "Услуги", выбрать мерчанта, пункт "Настройки протокола"->"Серверные уведомления"). <b>Адрес должен быть доступен из Интернета</b>.
