...
Using Pull REST API, merchant may also offer a Visa QIWI Wallet user to pay the invoice immediately by redirecting to the Visa QIWI Wallet Ñheckout page. 
